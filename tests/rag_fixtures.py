...
def rag_env(tmp_path, monkeypatch):
    ...
    import harness.rag.assets as assets_mod
    ...
    monkeypatch.setattr(rag_config, "ASSETS_DIR", rag_dir / "assets")
    ...
    monkeypatch.setattr(assets_mod, "ASSETS_DIR", rag_dir / "assets")
